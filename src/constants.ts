...
export const CATEGORIES = [
  { id: 'health', name: { en: 'HEALTH & WELLNESS', ar: 'الصحة والعافية', ku: 'تەندروستی و باشژیانی' }, icon: HeartPulse, types: 5, image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 'general', name: { en: 'SERVICES & OTHERS', ar: 'الخدمات وأخرى', ku: 'خزمەتگوزاری و ئەوانی تر' }, icon: MoreHorizontal, types: 4, image: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 'education', name: { en: 'EDUCATION', ar: 'التعليم والتدريب', ku: 'پەروەردە' }, icon: GraduationCap, types: 3, image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=400&auto=format&fit=crop' },
  { id: 'entertainment', name: { en: 'ENTERTAINMENT', ar: 'الترفيه والتسلية', ku: 'کات بەسەربردن' }, icon: Clapperboard, types: 3, image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 'realestate', name: { en: 'REAL ESTATE', ar: 'العقارات والمنزل', ku: 'خانووبەرە' }, icon: Home, types: 4, image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=400&auto=format&fit=crop' },
  ...
  { id: 'furniture', name: { en: 'FURNITURE & HOME', ar: 'الأثاث والديكور', ku: 'کەلوپەلی ناوماڵ' }, icon: Armchair, types: 4, image: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?q=80&w=400&auto=format&fit=crop' },
];
